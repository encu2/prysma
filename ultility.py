...
def headerS(CL = None): 
  ...
  headerUA = {
    ...
    'User-Agent':UA[(lambda x=0, y=len(UA):floor(random()*(y-x)+x))()]
  }
  if CL is not None and type(CL) is int:
    headerUA.update([('Content-Length', str(CL))])
...
def hostS():
  host = [
        ...
        'https://www.noip.com/',
        'https://mikrotikacademy.sttar.ac.id/',
        'https://www.expressvpn.com/',
        'https://ip-dynamic.com/',
        'https://www.w3schools.com/',
  ...
  return host[(lambda x=0, y=len(host):floor(random()*(y-x)+x))()]
